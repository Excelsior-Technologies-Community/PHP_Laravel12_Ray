            ...
            <form id="studentForm">
                ...
                <div class="mb-4">
                    ...
                    <div class="flex items-center gap-3">
                        <input type="checkbox" name="status" id="status" value="1" checked class="w-5 h-5">
                ...
                <div class="mb-6">
                    ...
                    <div class="dropzone" id="imageDropzone">
                        <div class="dz-message">
                            ...
                            <p class="text-gray-600">Drag & drop image here or click to upload</p>
                            <p class="text-xs text-gray-400">Max 2MB (JPEG, PNG, GIF)</p>
                        </div>
                    </div>
                    <input type="hidden" name="profile_image" id="profileImage" value="students/default-avatar.png">
                </div>
        ...
        $('#studentForm').on('submit', function(e) {
            ...
            $.ajax({
                ...
                error: function(xhr) {
                    ...
                    $('#submitBtn').html('💾 Save Student').prop('disabled', false);
                }
            });
        });
    </script>
